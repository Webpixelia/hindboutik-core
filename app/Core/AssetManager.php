...
class AssetManager
{
    ...
    public function registerAllAssets(): void
    {
        ...
        $this->registerJs('cart-drawer',          'frontend/cart-drawer.js',         ['jquery'], HINDBOUTIK_CORE_VERSION);
        ...
        $this->registerCss('cart-drawer',         'frontend/cart-drawer.css', [], HINDBOUTIK_CORE_VERSION);
